                        ...
                        <div class="col-md-8 offset-md-2">
                               ...
                               <div class="form-group">
                                  <div class="row">
                                      <div class="col-12">
                                          <div class="form-group">
                                              <input type="text" id="domain_name" name="domain_name" class="form-control domain" placeholder="Enter your Domain" value="" >
...
<!--                                               <i class="material-icons">remove_red_eye</i> -->
                              ...
                              <div class="form-group">
                                 <button type="button" id="sign_btn3" class="btn form-control request_btn" data-value="3"><img src="<?php echo base_url();?>assets/images/loading1.gif" width="22px" id="image" alt="loader">Sign Up</button>
                              </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 offset-md-2">
                           <p class="text-center curr-number"> </p>
                              ...
                              <div class="form-group">
                                 <button type="button" id="sign_btn4" value="Verify" class="btn form-control validate_btn" data-value="5"><img src="<?php echo base_url();?>assets/images/loading.gif" width="22px" id="image" alt="loader">Verify</button>
                              </div>
...
//} 
 ...
 $(document).on("click", "#re_enter_password", function(){
  $(".form-validation-error").remove();
     if(IsPassword($("#create_password").val())== false){
          
            $("#create_password").closest(".form-group").append(" <div class='form-validation-error' >Password must contain at least 8 characters, including atlist one uppercase,lowercase,number and spacial character.. </div>");
        }
