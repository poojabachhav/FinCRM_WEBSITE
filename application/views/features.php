		...
		<div class="container">
			...
			<div class="row features_content">
				<div class="col-lg-4 offset-lg-1">
					<div class="big_f_left">
						<img class="img-fluid" src="<?php echo base_url();?>assets/images/f-img1.png" alt="">
					</div>
				</div>
				...
				<img class="shape1"src="<?php echo base_url();?>assets/images/shape1.png" alt="">		
				<img class="shape2"src="<?php echo base_url();?>assets/images/shape2.png" alt="">		
				<img class="shape3"src="<?php echo base_url();?>assets/images/shape1.png" alt="">		
			</div>
			...
			<div class="row features_content bottom-features">
				...
				<div class="col-lg-5 offset-lg-2">
					<div class="big_f_left">
						<img class="img-fluid" src="<?php echo base_url();?>assets/images/f-img2.png" alt="">
					</div>
				</div>
				<div class="border-line"></div>
				<img class="shape1"src="<?php echo base_url();?>assets/images/shape1.png" alt="">		
					...
					<div class="owl-carousel brand-carousel">
						...
						<div class="single-brand-item d-table">
							<div class="d-table-cell">
								<img src="<?php echo base_url();?>assets/images/brands/logo1.png" alt="">
							</div>
						</div>
						<!-- single-brand -->
						<div class="single-brand-item d-table">
							<div class="d-table-cell">
								<img src="<?php echo base_url();?>assets/images/brands/logo2.png" alt="">
							</div>
						</div>
						<!-- single-brand -->
						<div class="single-brand-item d-table">
							<div class="d-table-cell">
								<img src="<?php echo base_url();?>assets/images/brands/logo3.png" alt="">
							</div>
						</div>
						<!-- single-brand -->
						<div class="single-brand-item d-table">
							<div class="d-table-cell">
								<img src="<?php echo base_url();?>assets/images/brands/logo4.png" alt="">
							</div>
						</div>
						<!-- single-brand -->
						<div class="single-brand-item d-table">
							<div class="d-table-cell">
								<img src="<?php echo base_url();?>assets/images/brands/logo5.png" alt="">
							</div>
						</div>
						<!-- single-brand -->
						<div class="single-brand-item d-table">
							<div class="d-table-cell">
								<img src="<?php echo base_url();?>assets/images/brands/logo6.png" alt="">
							</div>
						</div>
					</div>
				</div>
