...
<!-- Area =================--> 
    ...
    <section class="sign_in sign_in_domain section_1">
        <div class="container">
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12">
                            <div class="pt-3 pb-4 text-center">
                               <span class="sign_in_text text-center ">Welcome back !</span>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <form action="<?php echo base_url('home/load_domain');?>" class="sign_in_demo" method="post">
                              ...
                              <div class="form-group">
                                   <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <input type="text" name="domain_name" class="form-control" placeholder="CRM Domain Name" value="">
                                                    <span class="domainfix">.fincrm.net</span>
                                                  <i class="material-icons-outlined">filter_drama</i>
                                                    </div>
                                        </div>
                                    </div>
                              </div>
                              ...
                              <div class="form-group">
                                 <button type="submit" class="btn form-control request_btn take_me_there">Take Me There</button>
                              </div>
                            </form>
                        </div>
                    </div>
   ...
   <!--  <section class="sign_in sign_in_dn section_2 sign_in_main_login">
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-4 offset-md-4">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <form action="" class="sign_in_demo">
