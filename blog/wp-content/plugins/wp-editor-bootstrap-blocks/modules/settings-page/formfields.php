...
{
   $label = array( '','color-primary</code>, <code>bg-primary', 'color-secondary</code>, <code>bg-secondary', 'color-success</code>, <code>bg-success', 'color-danger</code>, <code>bg-danger', 'color-warning</code>, <code>bg-warning', 'color-info</code>, <code>bg-info');
   for ($i=1;$i<=6;$i++):
