...
<div class="section-part">
   <h2><?php _e('Global options',GUTENBERGBOOTSTRAP_SLUG)?></h2>
<?php
   ...
   print_select($gtb_options,'bootstrap_version', __('Load Bootstrap files version',GUTENBERGBOOTSTRAP_SLUG), array('4.3'=> __('Bootstrap 4.3', GUTENBERGBOOTSTRAP_SLUG)),__('Note: when this option is available, the Bootstrap Blocks plug-in loads the Bootstrap files selected here.',GUTENBERGBOOTSTRAP_SLUG));
...
<p style="float:right"><a href="#" onclick="resetToDefaults();return false" class="button"><?php _e('Reset settings',GUTENBERGBOOTSTRAP_SLUG)?></a></p>
<script>
   function resetToDefaults(){
   var r = confirm('reset to default settings?');
   if (r == true) document.location='?page=<?=GtbBootstrapSettingsPage::MENU_SLUG?>&reset=1';
   }
   </script>
<?php submit_button();?>
