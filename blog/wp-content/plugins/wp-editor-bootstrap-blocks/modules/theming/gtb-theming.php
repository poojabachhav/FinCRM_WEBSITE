	...
	function init_mod_gtb_theming()
	{
		...
		function enqueue_gtb_bootstrap_theming()
		{
			...
			if ($bootstrap_colors_included):
				$custom_css .= ".color-primary,.has-gtb-color-1-color{color:".$gtb_options['bootstrap_color1']."!important;}
...
.color-info,.has-gtb-color-7-color{color:#FFFFFF!important;}
.bg-info,.has-gtb-color-7-background-color{background-color:#FFFFFF!important;}
.color-info,.has-gtb-color-8-color{color:#000000!important;}
.bg-info,.has-gtb-color-8-background-color{background-color:#000000!important;}";
			endif;

			if (!$bootstrap_included || $bootstrap_on_template):

				// Styles.
				$bootstrap_version = !empty($gtb_options['bootstrap_version'])?$gtb_options['bootstrap_version']:'4.3';
