		...
		if ( 'edit-tags.php' === $page || 'term.php' === $page ) {
			...
			( function() {
				...
				jQuery( document ).ready( function( $ ) {
					...
					/* Add Image Link */
					jQuery( powerkitFeaturedContainer ).find( '.upload-img-link' ).live( 'click', function( event ){
					...
					/* Delete Image Link */
					$( powerkitFeaturedContainer ).find( '.delete-img-link' ).live( 'click', function( event ){
						event.preventDefault();
