...
function powerkit_share_buttons_add_facebook( $accounts, $share_url, $post_id ) {
	...
	/* Share text url */
	$share_text_url = esc_url( 'https://www.facebook.com/sharer.php?t=%text%&u=' . $share_url, null, '' );
...
function powerkit_share_buttons_add_twitter( $accounts, $share_url, $post_id ) {
	...
	/* Share text url */
	$share_text_url = esc_url( 'https://twitter.com/share?text=%text%&url=' . $share_url, null, '' );
...
function powerkit_share_buttons_add_pinterest( $accounts, $share_url, $post_id ) {
	...
	/* Share text url */
	$share_text_url = esc_url( 'https://pinterest.com/pin/create/bookmarklet/?description=%text%&url=' . $share_url . $media, null, '' );
...
function powerkit_share_buttons_add_mail( $accounts, $share_url, $post_id ) {
	...
	/* Share text url */
	$share_text_url = esc_url( 'mailto:?subject=' . $mail_text . '&body=%text%%20' . $share_url, null, '' );
