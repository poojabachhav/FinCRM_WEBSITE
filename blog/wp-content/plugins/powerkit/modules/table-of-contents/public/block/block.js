...
function (_Component) {
  ...
  function TOCBlockEdit() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(TOCBlockEdit).apply(this, arguments));
  }
...
function (_Component) {
  ...
  function TOCPreviewRender() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(TOCPreviewRender).apply(this, arguments));
    _this.state = {
      html: '',
      data: '',
      loading: false
  ...
  _createClass(TOCPreviewRender, [{
    ...
    value: function maybeFetchToc(props) {
      ...
      var title = attributes.title,
          ...
          minCharacters = attributes.minCharacters; // still loading.
      ...
      var newData = "".concat(title, " ").concat(depth, " ").concat(minCount, " ").concat(minCharacters, " ").concat(titlesData); // data was not changed.
