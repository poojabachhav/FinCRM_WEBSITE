...
/* harmony import */ var _edit_jsx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(115);
/* harmony import */ var _save_jsx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(116);
/**
...
function (_Component) {
  ...
  function AlertBlockEdit() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(AlertBlockEdit).apply(this, arguments));
    _this.state = {
      // fix for WP 5.2
...
function (_Component) {
  ...
  function AlertBlockSave() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(AlertBlockSave).apply(this, arguments));
  }
