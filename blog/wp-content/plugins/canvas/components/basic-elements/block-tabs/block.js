...
/* harmony import */ var _edit_jsx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(144);
...
function (_Component) {
  ...
  function TabsBlockEdit() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(TabsBlockEdit).apply(this, arguments));
    _this.state = {
      // fix for WP 5.2
...
function (_Component) {
  ...
  function TabsBlockSave() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(TabsBlockSave).apply(this, arguments));
  }
